...
Clean Architecture adalah sebuah pola arsitektur perangkat lunak yang diperkenalkan oleh Robert C. Martin (Uncle Bob). Tujuan utamanya adalah untuk memisahkan kekhawatiran (*separation of concerns*) antara logika bisnis inti dengan detail teknis seperti UI, database, dan framework.
